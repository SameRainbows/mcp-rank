  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-950">
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-semibold">Scoring methodology</h1>
        ...
        <section className="mt-8 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-semibold">Weighted score categories</h2>
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            {Object.entries(scoreLabels).map(([key, label]) => (
              <div key={key} className="rounded-md border border-zinc-200 bg-zinc-50 p-4">
        ...
        <section className="mt-8 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <ul className="mt-5 grid gap-3 text-sm leading-6 text-zinc-700">
            {sources.map((source) => (
              <li key={source} className="border-l-2 border-emerald-500 pl-3">
                {source}
              </li>
            ))}
          </ul>
        ...
        <section className="mt-8 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-semibold">Automation path</h2>
          <ol className="mt-5 grid gap-4 text-sm leading-6 text-zinc-700">
            ...
            <li>5. Publish weekly reports that separate recommendation from raw popularity.</li>
          </ol>
        </section>
      </section>
    </main>
